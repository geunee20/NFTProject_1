...
// contract nft_dropsV3 is ERC721, ERC721Holder, Ownable, VRFConsumerBase {
//     uint256 public constant MAX_PASSES = 10000;
//     uint256 public constant MAX_PRIME_PASSES = 100;
//     uint256 public constant MAX_MINT_PER_TX = 10;
//     uint256 public constant PRIME_SHARE = 10;
//     uint256 public PASS_PRICE = 0.1 ether;
//     uint256 public deadline;
//     uint256 public passCounter = 0;
//     uint256 public primeCounter = 0;
...
//     bool public primePassSet = false;
...
//     mapping(uint256 => bool) private primePasses;
...
//     function drawNormalWinner(uint256 _randomness) internal returns (address) {
...
//         } else {
//             return drawNormalWinner(RANDOM_NUMBER);
//         }
//     }

//     function drawPRimeWinner(uint256 _randomness) internal returns (address) {
//         RANDOM_NUMBER = linearCongruential(_randomness);
//         if (
//             isStaked[RANDOM_NUMBER % passCounter] &&
//             primePasses[RANDOM_NUMBER % passCounter]
//         ) {
//             return stakers[RANDOM_NUMBER % passCounter];
//         } else {
//             return drawPRimeWinner(RANDOM_NUMBER);
//         }
//     }
...
//         require(
//             primeNumberSet == true,
//             "Prime numbers shoud be set before start mint"
//         );
//         require(
//             primePassSet == true,
//             "Prime passes should be set before start mint"
//         );
...
//     function setPrimePass(uint256 passId) public onlyOwner {
//         require(primePassSet == false, "Prime passes are already set");
//         primePasses[passId] = true;
//         primeCounter++;
//         if (primeCounter >= MAX_PRIME_PASSES) {
//             primePassSet = true;
//         }
//     }
...
//     //     for (uint256 i = 0; i < passIds.length; i++) {
//     //         require(isStaked[passIds[i]] == true, "Token is not Staked");
//     //         require(stakers[passIds[i]] == msg.sender, "Check your token ID");
//     //         require(
//     //             block.timestamp - StakedTime[passIds[i]] > stakeTimeLimit,
//     //             "You cannot unstake yet"
//     //         );
//     //         safeTransferFrom(address(this), msg.sender, passIds[i]);
//     //         isStaked[passIds[i]] = false;
//     //     }
//     // }

//     // function setPrimePasses(uint256[] passIds) public onlyOwner {
//     //     require(primePassSet == false, "Prime passes are already set");
//     //     for (uint256 i = 0; i < passIds.length; i++) {
//     //         primePasses[passIds[i]] = true;
//     //         primeCounter++;
//     //     }
//     //     if (primeCounter >= MAX_PRIME_PASSES) {
//     //         primePassSet = true;
